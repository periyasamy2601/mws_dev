...
/// Represents a country with its name, flag, dialing codes, and translations.
class Country {
  ...
  /// Translations of the country's name keyed by language code (e.g., "en", "fr").
  final Map<String, String> nameTranslations;

  /// Emoji flag representation of the country (e.g., 🇮🇳).
  final String flag;

  /// Two-letter ISO country code (e.g., "IN").
  final String code;

  /// Primary dialing code (e.g., "+91").
  final String dialCode;

  /// Optional regional code for split country numbering (e.g., "2" in "+44 2").
  ...
  /// Returns the complete dialing code including any region code.
  String get fullCountryCode => '$dialCode$regionCode';

  /// Returns a display-friendly dialing code (e.g., "+44 2" if region exists).
  String get displayCC =>
      regionCode.isNotEmpty ? '$dialCode $regionCode' : dialCode;

  /// Returns the country name localized to the given [languageCode].
  /// Falls back to [name] if no translation is found.
