...
void main() {
  ...
  Widget createWidgetUnderTest() {
    return BlocProvider<NoInternetBloc>.value(
      ...
      child: MaterialApp(
        ...
        home: ResetPasswordView(baseRouteEntity: BaseRouteEntity(),),
      ),
    );
  }
  ...
  testWidgets('form validates successfully when all fields are filled', (WidgetTester tester) async {
    ...
    await tester.enterText(find.widgetWithText(TextFormField, 'New Password'), '1234');
    await tester.enterText(find.widgetWithText(TextFormField, 'Confirm Password'), '2345');
